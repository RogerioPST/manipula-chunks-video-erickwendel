...
for mediaFile in `ls $ASSETSFOLDER | grep .mp4`; do
	...
	#ve apenas a duration ref às informações do video, substituindo duration= por em branco e deixando apenas o valor
